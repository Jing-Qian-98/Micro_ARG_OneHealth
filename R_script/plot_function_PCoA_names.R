...
# bray_curtis距离计算
dist <- vegdist(funcAbd_rel, method=in_method)
dist <- as.matrix(dist)
...
# hull
## 输出PDF
pdf(paste0("PCoA.", in_method,".function.hull.pdf"), width =6, height =5, bg="white", onefile=F)
print(q1)
dev.off()

## 输出svg
svg(paste0("PCoA.", in_method, ".function.hull.svg"),width =6,height =5,bg="white", onefile=F)
print(q1)
dev.off()

## 输出PNG
png(paste0("PCoA.", in_method,".function.hull.png"),width =6,height =5,units="in",res=100,bg="white")
print(q1)
dev.off()

# ellipse
## 输出PDF
pdf(paste0("PCoA.", in_method,".function.ellipse.pdf"),width =6, height =5, bg="white", onefile=F)
print(q2)
dev.off()

## 输出svg
svg(paste0("PCoA.", in_method,".function.ellipse.svg"), width =6, height =5, bg="white", onefile=F)
print(q2)
dev.off()

## 输出PNG
png(paste0("PCoA.", in_method,".function.ellipse.png"), width =6, height =5, units="in", res=100, bg="white")
print(q2)
dev.off()

## 输出PDF
pdf(paste0("PCoA.", in_method,".function.common.pdf"), width =6,  height =5, bg="white", onefile=F)
print(q3)
dev.off()

## 输出svg
svg(paste0("PCoA.", in_method,".function.common.svg"), width =6, height =5, bg="white", onefile=F)
print(q3)
dev.off()

## 输出PNG
png(paste0("PCoA.", in_method,".function.common.png"), width =6, height =5, units="in", res=100, bg="white")
print(q3)
dev.off()
